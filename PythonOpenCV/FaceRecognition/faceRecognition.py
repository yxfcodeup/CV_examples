...
img1 = cv2.imread("vsmodel1.jpg")
gray_img = cv2.cvtColor(img1 , cv2.COLOR_BGR2GRAY)
# cv2.cvtColor(img1 , gray_img ,  cv2.COLOR_BGR2GRAY)
face_cascade = cv2.CascadeClassifier("./haarcascade_frontalface_default.xml")
faces = face_cascade.detectMultiScale(gray_img , scaleFactor = 1.1 , minNeighbors = 3 , minSize = (5 , 5))
